...

{
	...
	{Item = "fat.animal",           Min = 5,    Max = 20,   Chance = 20},

	{Item = "metalblade",          Min = 1,    Max = 1,    Chance = 16},

	{Item = "rope",                 Min = 1,    Max = 2,    Chance = 15},

	{Item = "sewingkit",           Min = 3,    Max = 4,    Chance = 8},

	{Item = "propanetank",         Min = 1,    Max = 4,    Chance = 8},

	{Item = "tarp",                 Min = 1,    Max = 1,    Chance = 8},

	{Item = "lowgradefuel",       Min = 3,    Max = 7,    Chance = 4},

	{Item = "semibody",       Min = 1,    Max = 1,    Chance = 1},

	{Item = "sheetmetal",          Min = 1,    Max = 1,    Chance = 1},

	{Item = "metal_spring",         Min = 1,    Max = 1,    Chance = 1},

	{Item = "roadsigns",           Min = 3,    Max = 4,    Chance = 1},

	{Item = "gears",                Min = 2,    Max = 4,    Chance = 1},

	{Item = "metalpipe",           Min = 1,    Max = 4,    Chance = 1},

	{Item = "fuse",                 Min = 1,    Max = 1,    Chance = 1},

	{Item = "scard",             	Min = 1,    Max = 1,    Chance = 1},
