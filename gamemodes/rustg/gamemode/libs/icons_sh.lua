    ...
    function gRust.CreateIcon(name, dir)
        Icons[name] = Material(dir, "smooth mips")
    end
    ...
    gRust.CreateIcon("favorite_active", "icons/favorite_active.png")
    gRust.CreateIcon("favorite_inactive", "icons/favorite_inactive.png")

    gRust.CreateIcon("steam", "icons/steam.png")
    gRust.CreateIcon("discord", "icons/discord.png")
    gRust.CreateIcon("web", "icons/web.png")
