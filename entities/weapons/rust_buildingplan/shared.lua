...
buildingsTable = {
    ["foundation"] = {
        ...
        ["parent"] = {
            ...
            ["positions"] = {
                [1] = {["position"] = Vector(0,-129,0), ["angle"] = Angle(0,0,0)},
                [2] = {["position"] = Vector(129,0,0), ["angle"] = Angle(0,0,0)},
                [3] = {["position"] = Vector(-129,0,0), ["angle"] = Angle(0,0,0)},
                [4] = {["position"] = Vector(0,129,0), ["angle"] = Angle(0,0,0)}
            }
        }
    },
    ...
    ["foundation_triangle"] = {
        ...
        ["parent"] = {
            ["buildings"] = {"foundation", "map"},
            ["positions"] = {
                [1] = {["position"] = Vector(-110,0,0), ["angle"] = Angle(0,180,0)},
                [2] = {["position"] = Vector(0,-64.5,0), ["angle"] = Angle(0,-30,0)},
                [3] = {["position"] = Vector(0,64.5,0), ["angle"] = Angle(0,30,0)}
            }
        }
    },
    ...
    ["wall"] = {
        ...
        ["parent"] = {
            ...
            ["positions"] = {
                [1] = {["position"] = Vector(0,-64.5,0), ["angle"] = Angle(0,90,0)},
                [2] = {["position"] = Vector(64.5,0,0), ["angle"] = Angle(0,180,0)},
                [3] = {["position"] = Vector(-64.5,0,0), ["angle"] = Angle(0,0,0)},
                [4] = {["position"] = Vector(0,64.5,0), ["angle"] = Angle(0,270,0)}
            }
        }
    },
    ...
    ["wall_half"] = {
        ...
        ["parent"] = {
            ...
            ["positions"] = {
                [1] = {["position"] = Vector(0,-64.5,0), ["angle"] = Angle(0,-90,0)},
                [2] = {["position"] = Vector(64.5,0,0), ["angle"] = Angle(0,0,0)},
                [3] = {["position"] = Vector(-64.5,0,0), ["angle"] = Angle(0,180,0)},
                [4] = {["position"] = Vector(0,64.5,0), ["angle"] = Angle(0,90,0)}
            }
        }
    },
    ...
    ["floor"] = {
        ...
        ["parent"] = {
            ...
            ["positions"] = {
                [1] = {["position"] = Vector(0,64.5,129), ["angle"] = Angle(0,0,0)},
                [2] = {["position"] = Vector(0,64.5,129), ["angle"] = Angle(0,0,0)},
                [3] = {["position"] = Vector(0,-64.5,129), ["angle"] = Angle(0,0,0)},
                [4] = {["position"] = Vector(0,-64.5,129), ["angle"] = Angle(0,0,0)}
            }
        }
    },
    ...
    ["floor_triangle"] = {
        ...
        ["parent"] = {
            ["buildings"] = {"wall", "foundation"},
            ["positions"] = {
                [1] = {["position"] = Vector(-110,0,129), ["angle"] = Angle(0,180,0)},
                [2] = {["position"] = Vector(0,-70,129), ["angle"] = Angle(0,-30,0)},
                [3] = {["position"] = Vector(0,70,129), ["angle"] = Angle(0,30,0)}
            }
        }
    },
    ...
    ["steps"] = {
        ...
        ["parent"] = {
            ...
            ["positions"] = {
                [1] = {["position"] = Vector(0,-124,-62), ["angle"] = Angle(0,90,0)},
                [2] = {["position"] = Vector(124,0,-62), ["angle"] = Angle(0,180,0)},
                [3] = {["position"] = Vector(-124,0,-62), ["angle"] = Angle(0,0,0)},
                [4] = {["position"] = Vector(0,124,-62), ["angle"] = Angle(0,270,0)}
            }
        }
    },
    ...
    ["stairs_l"] = {
        ...
        ["parent"] = {
            ["buildings"] = {"foundation", "floor"},
            ["positions"] = {
                [1] = {["position"] = Vector(0,124,60), ["angle"] = Angle(0,90,0)},
                [2] = {["position"] = Vector(124,0,60), ["angle"] = Angle(0,180,0)},
                [3] = {["position"] = Vector(-124,0,60), ["angle"] = Angle(0,0,0)},
                [4] = {["position"] = Vector(0,-124,60), ["angle"] = Angle(0,270,0)}
            }
        }
    },
...
function GetPositionsForParent(buildingType, parentType)
    if not buildingsTable[buildingType] then
        return nil
    end
    
    local buildingData = buildingsTable[buildingType]
    if not buildingData["parent"] or not buildingData["parent"]["positions"] then
        return nil
    end
    
    -- РџСЂРѕРІРµСЂСЏРµРј РЅРѕРІСѓСЋ СЃС‚СЂСѓРєС‚СѓСЂСѓ (СЃ РѕС‚РґРµР»СЊРЅС‹РјРё РїРѕР·РёС†РёСЏРјРё РґР»СЏ СЂРѕРґРёС‚РµР»РµР№)
    if type(buildingData["parent"]["positions"]) == "table" and buildingData["parent"]["positions"][parentType] then
        return buildingData["parent"]["positions"][parentType]
    end
...
function GetParentPositions(buildingType, parentType)
    ...
    if buildingsTable[buildingType] and buildingsTable[buildingType]["parent"] and buildingsTable[buildingType]["parent"]["positions"] then
        for _, positions in pairs(buildingsTable[buildingType]["parent"]["positions"]) do
            if type(positions) == "table" and positions[1] then
                return positions
            end
        end
    end
...
function GetBuildingPosition(buildingType, parentType, positionIndex)
    local positions = GetPositionsForParent(buildingType, parentType)
    if positions and positions[positionIndex] then
        return positions[positionIndex]["position"], positions[positionIndex]["angle"]
    end
...
function IsPositionOccupied(pos, buildingType, excludeEnt)
    ...
    for _, ent in ipairs(entities) do
        if IsValid(ent) and ent:GetClass() == "rust_building" then
            if not excludeEnt or ent != excludeEnt then
                return true, ent
            end
        end
    end
...
function CheckGroundSupport(pos, buildingType)
    if buildingType != "foundation" then
        return true
    end
...
function GetNumberOfPosition(angle)
    if(angle != nil)then
        if(angle.y < -45 && angle.y > -135)then
            return 1
        elseif(angle.y > -45 && angle.y < 45)then
            return 2
        elseif(angle.y < -135 || angle.y > 135)then
            return 3
        elseif(angle.y > 45 && angle.y < 135)then
            return 4
        else
            return nil
        end
