...
gRust.BuildingBlocks =
{
    ["models/building_re/twig_foundation.mdl"] =
    {
        ...
        Sockets =
        {
            {pos = Vector(64.5, 0, 0), ang = Angle(0, 0, 0)},
            {pos = Vector(0, 64.5, 0), ang = Angle(0, 0, 0)},
            {pos = Vector(-64.5, 0, 0), ang = Angle(0, 0, 0)},
            {pos = Vector(0, -64.5, 0), ang = Angle(0, 0, 0)}
        }
    },
    ["models/building_re/twig_foundation_trig.mdl"] =
    {
        ...
        Sockets =
        {
            {pos = Vector(-55, 0, 0), ang = Angle(0, 180, 0)},
            {pos = Vector(0, -64.5/2, 0), ang = Angle(0, -30, 0)},
            {pos = Vector(0, 64.5/2, 0), ang = Angle(0, 30, 0)},
        }
    },
    ["models/building_re/twig_wall.mdl"] =
    {
        ...
        Sockets =
        {
            {pos = Vector(0, 0, 0), ang = Angle(), place = false},
            {pos = Vector(0, 0, 129), ang = Angle(0, 90, 0), relative = false},
        }
    },
    ["models/building_re/twig_wind.mdl"] =
    {
        ...
        {
            {pos = Vector(0, 0, 0), ang = Angle(), place = false},
            {pos = Vector(0, 0, 129), ang = Angle(0, 90, 0)},
            ["window"] = {
    ...
    ["models/building_re/twig_dframe.mdl"] =
    {
        ...
        Sockets =
        {
            ...
            {pos = Vector(0, 0, 129), ang = Angle(0, 90, 0), relative = false},
            ["door"] = {
                {pos = Vector(-25.5, 0, 3.5), ang = Angle(0, 0, 0)},
                {pos = Vector(25.5, 0, 3.5), ang = Angle(0, 180, 0)},
        },
        ["vending_machine"] = {
            {pos = Vector(0, -1, 5), ang = Angle(0, 90, 0)},
            {pos = Vector(0, 1, 5), ang = Angle(0, -90, 0)}
        }
        }
    },
    ["models/building_re/twig_gframe.mdl"] =
    {
        ...
        Sockets =
        {
            ...
            ["garage"] = {
                {pos = Vector(0, -4, 129), ang = Angle(0, 0, 0)},
            }
        }
    },
    ...
    ["models/building_re/twig_floor_trig.mdl"] =
    {
        ...
        {
            {pos = Vector(-55, 0, 0), ang = Angle(0, 180, 0)},
            {pos = Vector(0, -70/2, 0), ang = Angle(0, -30, 0)},
            {pos = Vector(0, 70/2, 0), ang = Angle(0, 30, 0)},
        }
    },
    ["models/building_re/twig_hwall.mdl"] =
    {
        ...
        Sockets =
        {
            {pos = Vector(0, 0, 0), ang = Angle(0, -90, 0), place = false},
            {pos = Vector(0, 0, 129/2), ang = Angle(0, 90, 0), relative = false},
        }
    },
    ["models/building_re/twig_twall.mdl"] =
    {
        ...
        {
            {pos = Vector(0, 0, 0), ang = Angle(0, -90, 0), place = false},
            {pos = Vector(0, 0, 129/3), ang = Angle(0, 90, 0), relative = false},
        }
    },
    ["models/building_re/twig_steps.mdl"] =
    {
        ...
        Sockets =
        {
            {pos = Vector(0, -62, -62), ang = Angle(0, 90, 0), place = false}
        }
    },
    ["models/building_re/twig_lst.mdl"] =
    {
        ...
        Sockets =
        {
            {pos = Vector(0, 62, 0), ang = Angle(0, 90, 0), place = false}
        }
    },
