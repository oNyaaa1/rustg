...
function ENT:Initialize()
    ...
    if self:GetNetworkedString("buildingtype") == nil or self.player == nil then self:Remove() end
...
function ENT:Think()
    if self:GetNetworkedString("buildingtype") == nil or self.player == nil then self:Remove() end
    if not IsValid(self:GetNetworkedString("parent")) and self.therewasparent then self:Remove() end
