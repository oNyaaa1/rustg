...
ENT.Options = {
    {
        ...
        Func = function(i, ent) LocalPlayer():Interact(ent) end
    },
    {
        Name = "Pickup Lock",
        Desc = "Open or Closes the door",
        ...
        Condition = function(ent) return ent:GetBodygroup(2) ~= 0 end,
    },
    {
        Name = "Enter Code",
        Desc = "Open or Closes the door",
        ...
        Condition = function(ent) return ent:GetBodygroup(2) == 1 end,
    },
    {
        Name = "Set Code",
        Desc = "Open or Closes the door",
